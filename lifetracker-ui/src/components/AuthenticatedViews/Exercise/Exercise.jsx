    ...
    return (
        ...
        <div id="nut">
            ...
            <div id="btn" className={btnclass}>
                <button onClick={() => {setForm(true)}} style={{backgroundColor:"blue", color:"white", width:"300px", fontSize:"30px", cursor:"pointer"}}>Record Exercise</button>
            </div>
            <br/>
            <br/>
            ...
            <div id="actual1">
                    <form onSubmit={handleSubmit}>
                        <div>
                        <input id="input" size={65} value={name} type='text' placeholder='Name of Exercise' onChange={(e) => {setName(e.target.value)}}/>
                        </div>
                        <br/>
                        <div>
                        <input id="input" size={65} value={duration} type='number' min={0}  placeholder='Duration (minutes)' onChange={(e) => {setDuration(e.target.value)}} />
                        </div>
                        <br/>
                        <div>
                            <label>Level of Intensity (1-10)</label>
                            <br/>
                            <br/>
                        ...
                        <br/>
                        <br/>
                        <button id="login" type="submit" style={{backgroundColor:"blue", width:"465px"}}>Record Exercise</button>
                    </form>
